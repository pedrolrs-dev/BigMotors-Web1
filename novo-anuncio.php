                ...
                <div class="card shadow-sm p-4 border-0 bg-white">
                    ...
                    <form id="formAddVeiculo" action="actions/novo_anuncio_action.php" method="POST" enctype="multipart/form-data">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label for="inputModelo" class="form-label small fw-semibold text-muted">Modelo</label>
                            ...
                            <div class="col-md-4">
                                <label for="inputCor" class="form-label small fw-semibold text-muted">Cor</label>
                                <input type="text" class="form-control" required id="inputCor" name="cor" placeholder="ex: Prata">
                            </div>

                            <div class="col-md-4">
                                <label for="inputKm" class="form-label small fw-semibold text-muted">KM</label>
                            ...
                            <div class="col-md-8">
                                <label for="inputCidade" class="form-label small fw-semibold text-muted">Cidade</label>
                            ...
                            <div class="col-12 mt-4">
                                ...
                                <div class="mb-2">
                                    <label for="fotoVeiculo1" class="form-label small fw-semibold text-muted">Foto 1</label>
                                    <input class="form-control" type="file" id="fotoVeiculo1" name="foto1" accept="image/*" required>
                                </div>
                                <div class="mb-2">
                                    <label for="fotoVeiculo2" class="form-label small fw-semibold text-muted">Foto 2</label>
                                    <input class="form-control" type="file" id="fotoVeiculo2" name="foto2" accept="image/*" required>
                                </div>
                                <div class="mb-3">
                                    <label for="fotoVeiculo3" class="form-label small fw-semibold text-muted">Foto 3</label>
                                    <input class="form-control" type="file" id="fotoVeiculo3" name="foto3" accept="image/*" required>
                                </div>
                            </div>
