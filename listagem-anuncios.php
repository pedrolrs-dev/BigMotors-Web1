        ...
        <div class="d-flex flex-column gap-3" id="listaMeusAnuncios">
            ...
            <div class="card shadow-sm border-0 bg-white p-3">
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-12 col-sm-5">
                        <h3 class="h6 fw-bold text-dark mb-1">Honda Civic EXL</h3>
            ...
            <div class="card shadow-sm border-0 bg-white p-3">
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-12 col-sm-5">
                        <h3 class="h6 fw-bold text-dark mb-1">Volkswagen Gol 1.6</h3>
            ...
            <div class="card shadow-sm border-0 bg-white p-3">
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-12 col-sm-5">
                        <h3 class="h6 fw-bold text-dark mb-1">Chevrolet Onix LT</h3>
