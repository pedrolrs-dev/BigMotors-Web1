    ...
    <main class="container my-5">
        ...
        <div class="row g-3 mb-4">
            <div class="col-6 col-md-3">
                <div class="card shadow-sm border-0 bg-white p-3 text-center">
                    <p class="h4 fw-bold text-primary mb-0">3</p>
                    <p class="text-muted small mb-0">Anúncios ativos</p>
                </div>
            </div>
            <div class="col-6 col-md-3">
        ...
        <div class="row g-4">
            <div class="col-12 col-md-6">
                <div class="card shadow-sm border-0 bg-white p-4 h-100 d-flex flex-column">
